 ...
 */
public class ExportPrivatKundenDatenblatt {

    private String filename;
    private KundenObj kunde;
    private String templatePath = Filesystem.getTemplatePath() +
            File.separatorChar + "word" + File.separatorChar + "kundendatenblatt.xml";
    private Hashtable ht = new Hashtable();


    public ExportPrivatKundenDatenblatt(String filename, KundenObj kunde){
        super();
...
//                        System.out.println("Name: " + name.toUpperCase());
    ...
    private void generateHashTable(){
        ...
        //TODO        
        hashPut("KUNDENAUFTRAG", "vorhanden");
        hashPut("DATENBLATT", "vorhanden");
        hashPut("POLICENKOPIE", "vorhanden");
