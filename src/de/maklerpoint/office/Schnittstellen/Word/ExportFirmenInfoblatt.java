 ...
 * @author yves
 */
public class ExportFirmenInfoblatt {

    private String filename;
    private FirmenObj firma;
    private String templatePath = Filesystem.getTemplatePath() +
            File.separatorChar + "word" + File.separatorChar + "geschaefskunden_infoblatt.xml";
    private Hashtable ht = new Hashtable();

    public ExportFirmenInfoblatt(String filename, FirmenObj firma) {
