...
/*
 * PanelEinrichtungMandant.java
 *
 * Created on 09.09.2010, 13:07:10
 */
 ...
 * @author yves
 */
public class PanelEinrichtungMandant extends javax.swing.JPanel implements iAssistent {

    private EinrichtungsAssistentDialog as;

    /** Creates new form PanelEinrichtungMandant */
    public PanelEinrichtungMandant() {
        initComponents();
    }
    ...
    public String getStepName() {
        return "Angaben zu Ihrem Unternehmen";
    }
    ...
    public boolean validateSettings() {
        if(this.field_firmenname.getText() == null) {
            JOptionPane.showMessageDialog(null, "Bitte geben Sie einen Unternehmensnamen an.");
            return false;
        }
    ...
    public void saveSettings() {
        MandantenObj md = new MandantenObj();

        md.setFirmenName(field_firmenname.getText());
        md.setFirmenZusatz(this.field_firmenZusatz.getText());
        md.setStrasse(field_strasse.getText());
        md.setPlz(field_plz.getText());
        md.setOrt(field_ort.getText());
        md.setFirmenRechtsform((String) this.combo_rechtsform.getSelectedItem());
        md.set34c(this.check_34c.isSelected());
        md.set34d(this.check_34d.isSelected());
        md.setIhkRegistriernummer(this.field_ihknummer.getText());

        md.setTelefon(this.field_telefon.getText());
        md.setTelefon2(this.field_telefon2.getText());
        md.setFax(this.field_fax.getText());
        md.setEmail(this.field_email.getText());
        md.setMobil(this.field_mobil.getText());
        md.setHomepage(this.field_internet.getText());

        md.setCreated(new java.sql.Timestamp(System.currentTimeMillis()));
        md.setModified(new java.sql.Timestamp(System.currentTimeMillis()));

        md.setStatus(Status.NORMAL);

        try {
            int id = MandantenSQLMethods.insertIntomandanten(DatabaseConnection.open(), md);
            md.setId(id);

            BasicRegistry.currentMandant = md;
        } catch (SQLException e) {
            Log.databaselogger.fatal("Konnte den Mandanten nicht anlegen", e);
            ShowException.showException("Der Mandant konnte nicht angelegt werden. Unter Details "
                    + "finden Sie weitere Informationen zu dem Fehler",
                    ExceptionDialogGui.LEVEL_FATAL, e,
                    "Schwerwiegend: Konnte Mandanten nicht anlegen");
        }
    }
    ...
    private void initComponents() {
        ...
        field_internet = new javax.swing.JTextField();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(de.maklerpoint.office.start.CRM.class).getContext().getResourceMap(PanelEinrichtungMandant.class);
        ...
        field_email.setPreferredSize(new java.awt.Dimension(120, 25));

        field_internet.setName("field_internet"); // NOI18N
        field_internet.setPreferredSize(new java.awt.Dimension(120, 25));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jSeparator4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 410, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(field_internet, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                            .addComponent(field_email, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                            .addComponent(field_telefon2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)))
                    .addComponent(jSeparator8, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 410, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addComponent(jLabel37)
                        .addGap(18, 18, 18)
                        .addComponent(field_ihknummer, javax.swing.GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addComponent(jLabel26)
                        .addGap(18, 18, 18)
                        .addComponent(field_strasse, javax.swing.GroupLayout.DEFAULT_SIZE, 347, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addComponent(jLabel27)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(field_plz, javax.swing.GroupLayout.DEFAULT_SIZE, 61, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(field_ort, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(combo_beratertyp, 0, 327, Short.MAX_VALUE))
                    .addComponent(jSeparator7, javax.swing.GroupLayout.DEFAULT_SIZE, 410, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(combo_rechtsform, javax.swing.GroupLayout.Alignment.LEADING, 0, 325, Short.MAX_VALUE)
                            .addComponent(field_firmenZusatz, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 325, Short.MAX_VALUE)
                            .addComponent(field_firmenname, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 325, Short.MAX_VALUE)))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel17)
                            .addComponent(field_internet, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    public javax.swing.JCheckBox check_34c;
    public javax.swing.JCheckBox check_34d;
    public javax.swing.JComboBox combo_beratertyp;
    public javax.swing.JComboBox combo_rechtsform;
    public javax.swing.JTextField field_email;
    public javax.swing.JTextField field_fax;
    public javax.swing.JTextField field_firmenZusatz;
    public javax.swing.JTextField field_firmenname;
    public javax.swing.JTextField field_ihknummer;
    public javax.swing.JTextField field_internet;
    ...
    public javax.swing.JTextField field_telefon2;
