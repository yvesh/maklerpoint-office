 ...
 */
/*
 * SchadenForderungDialog.java
 *
 * Created on 26.07.2011, 11:36:17
 */
 ...
 */
public class SchadenForderungDialog extends javax.swing.JDialog {

    private boolean update = false;
    private SchadenObj sch = null;
    private SchadenForderungObj sf = null;

    /** Creates new form SchadenForderungDialog */
    public SchadenForderungDialog(java.awt.Frame parent, boolean modal, SchadenObj sch) {
        super(parent, modal);
        this.update = false;
        this.sch = sch;
        initComponents();
    ...
    public SchadenForderungDialog(java.awt.Frame parent, boolean modal, SchadenForderungObj sf) {
        super(parent, modal);
        this.update = false;
        this.sch = null;
        this.sf = sf;
    ...
    private void setUp() {
        this.ffield_effektiv.setValue(0.00);
        this.ffield_sb.setValue(0.00);
        this.ffield_gesamt.setValue(0.00);
        loadForderung();
    }

    private void loadForderung() {
        if (sf == null) {
            return;
        }

        this.text_comments.setText(sf.getComments());

        this.ffield_gesamt.setValue(sf.getGesamtforderung());
        this.ffield_sb.setValue(sf.getSelbstbeteiligung());
        this.ffield_effektiv.setValue(sf.getEffektiveforderung());

        this.date_beleg.setDate(sf.getBelegVon());
    ...
    private void initComponents() {
        ...
        ffield_effektiv = new javax.swing.JFormattedTextField();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(de.maklerpoint.office.start.CRM.class).getContext().getResourceMap(SchadenForderungDialog.class);
        ...
        ffield_gesamt.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.00"))));
        ...
        ffield_sb.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.00"))));
        ...
        ffield_effektiv.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.00"))));
        ffield_effektiv.setEnabled(false);
        ffield_effektiv.setName("ffield_effektiv"); // NOI18N
        ...
        panel_basisLayout.setHorizontalGroup(
            ...
            .addGroup(panel_basisLayout.createSequentialGroup()
                ...
                .addGroup(panel_basisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jSeparator8, javax.swing.GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)
                    .addComponent(jSeparator7, javax.swing.GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)
                    .addGroup(panel_basisLayout.createSequentialGroup()
                        .addGroup(panel_basisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(panel_basisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(field_zahltext, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
                            .addComponent(field_zahlungvon, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_basisLayout.createSequentialGroup()
                        .addComponent(jLabel19)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 87, Short.MAX_VALUE)
                        .addComponent(ffield_effektiv, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jSeparator6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_basisLayout.createSequentialGroup()
                    ...
                    .addGroup(panel_basisLayout.createSequentialGroup()
                        ...
                        .addComponent(ffield_sb, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(panel_basisLayout.createSequentialGroup()
                        .addGroup(panel_basisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panel_basisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(field_adresse, javax.swing.GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE)
                            .addComponent(field_anspruchsteller, javax.swing.GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE))))
                .addContainerGap())
        );
        panel_basisLayout.setVerticalGroup(
            ...
            .addGroup(panel_basisLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_basisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ffield_effektiv, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pane, javax.swing.GroupLayout.DEFAULT_SIZE, 367, Short.MAX_VALUE)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (update == false) {
            sf = new SchadenForderungObj();
            sf.setSchadenId(sch.getId());
            sf.setCreatorId(BasicRegistry.currentUser.getId());
        }

        sf.setComments(text_comments.getText());

        sf.setModified(new java.sql.Timestamp(System.currentTimeMillis()));
        try {
            if (update == false) {
                sf.setCreated(new java.sql.Timestamp(System.currentTimeMillis()));
                int id = SchadenForderungenSQLMethods.insertIntoSchaeden_forderungen(DatabaseConnection.open(), sf);

            } else {
                boolean success = SchadenForderungenSQLMethods.updateSchaeden_forderungen(DatabaseConnection.open(), sf);

                if (!success) {
                    Log.databaselogger.fatal("Konnte die Schadenforderung nicht updaten (nicht gefunden).");
                    ShowException.showException("Datenbankfehler: Der Schadenforderung konnte nicht aktualisiert werden",
                            ExceptionDialogGui.LEVEL_WARNING, "Konnte Schadenforderung nicht speichern");
                }
            }
            this.dispose();
        } catch (SQLException e) {
            Log.databaselogger.fatal("Konnte die Schadenforderung nicht speichern.");
            ShowException.showException("Datenbankfehler: Die Schadenforderung konnte nicht gespeichert werden.",
                    ExceptionDialogGui.LEVEL_WARNING, e, "Konnte Schadenforderung nicht speichern");
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SchadenForderungDialog dialog = new SchadenForderungDialog(new javax.swing.JFrame(), true, new SchadenObj());
                // Really bad constructor
    ...
    private javax.swing.JFormattedTextField ffield_effektiv;
