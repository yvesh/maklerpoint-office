 ...
 */
public class KundenImportDialog extends javax.swing.JDialog {
    ...
    public KundenImportDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.kunden = null;
        initComponents();
        setUp();
    ...
    private void addButtons() {
        JCommandButton neuButton = new JCommandButton("Neue Importvorlage", getResizableIconFromResource("de/acyrance/CRM/Gui/resources/add.png"));
        ...
        JCommandButton importButton = new JCommandButton("Import", getResizableIconFromResource("de/acyrance/CRM/Gui/resources/import.png"));
            ...
            excel.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ae) {
                    try {
                        ...
                        ShowException.showException("Der Importvorlage konnte nicht geöffnet werden. Sie finden die Vorlage im Verzeichnis \""
                                + Filesystem.getVorlagenPath() + File.separatorChar + "import" + File.separatorChar + "\" .",
...
//             tableNachrichtenPopupMenu.show(e.getComponent(), e.getX(), e.getY());
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(de.maklerpoint.office.start.CRM.class).getContext().getResourceMap(KundenImportDialog.class);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        for (int i = 0; i < kunden.length; i++) {
            ...
            try {
                ...
                ShowException.showException("Der neue Kunde (" + kunden[i].getNachname() + ") konnte nicht gespeichert werden. Bitte "
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                KundenImportDialog dialog = new KundenImportDialog(new javax.swing.JFrame(), true);
